...
const en = {
  ...
  "settings.section.frpc": "FRP Client",
  "frpc.name": "Name",
  "frpc.file_name": "File Name",
  "frpc.config_content": "Configuration (TOML)",
  "frpc.status.running": "Running",
  "frpc.status.stopped": "Stopped",
  "frpc.start": "Start",
  "frpc.stop": "Stop",
  "frpc.save": "Save",
  "frpc.save_success": "Config saved",
  "frpc.create_success": "Config created",
  "frpc.new": "+ New Config",
  "frpc.empty": "No frpc configurations yet",
  "frpc.enabled": "Auto-start",
  "frpc.delete": "Delete",
  "frpc.confirm_delete": "Delete this frpc config?",
  "frpc.running_edit_warning": "Config is running. Changes will take effect after restart.",
  "frpc.name_empty": "Config name cannot be empty",
  "frpc.log.title": "Logs",
  "frpc.log.empty": "No logs yet",
  ...
  "error.frpc_already_running": "frpc is already running for this config",
  "error.frpc_not_running": "frpc is not running for this config",
  "error.frpc_binary_not_found": "frpc binary not found. Install frpc or set the path in Settings.",
  "error.frpc_config_not_found": "frpc config not found",
  "error.frpc_file_not_found": "frpc config file not found: {path}",
  "error.frpc_path_traversal": "Invalid file path",
  "error.frpc_spawn_failed": "Failed to start frpc: {err}",
  "error.frpc_stop_failed": "Failed to stop frpc: {err}",
  "error.frpc_name_empty": "Config name cannot be empty",
};
