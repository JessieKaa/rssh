...
const zh: Messages = {
  ...
  "settings.section.frpc": "FRP 客户端",
  "frpc.name": "名称",
  "frpc.file_name": "文件名",
  "frpc.config_content": "配置内容 (TOML)",
  "frpc.status.running": "运行中",
  "frpc.status.stopped": "已停止",
  "frpc.start": "启动",
  "frpc.stop": "停止",
  "frpc.save": "保存",
  "frpc.save_success": "配置已保存",
  "frpc.create_success": "配置已创建",
  "frpc.new": "+ 新建配置",
  "frpc.empty": "暂无 frpc 配置",
  "frpc.enabled": "自动启动",
  "frpc.delete": "删除",
  "frpc.confirm_delete": "确定删除此 frpc 配置？",
  "frpc.running_edit_warning": "配置正在运行中，修改将在重启后生效。",
  "frpc.name_empty": "配置名称不能为空",
  "frpc.log.title": "日志",
  "frpc.log.empty": "暂无日志",
  ...
  "error.frpc_already_running": "该配置的 frpc 已在运行中",
  "error.frpc_not_running": "该配置的 frpc 未在运行",
  "error.frpc_binary_not_found": "未找到 frpc 可执行文件，请安装 frpc 或在设置中指定路径。",
  "error.frpc_config_not_found": "未找到 frpc 配置",
  "error.frpc_file_not_found": "未找到 frpc 配置文件：{path}",
  "error.frpc_path_traversal": "无效的文件路径",
  "error.frpc_spawn_failed": "启动 frpc 失败：{err}",
  "error.frpc_stop_failed": "停止 frpc 失败：{err}",
  "error.frpc_name_empty": "配置名称不能为空",
};
